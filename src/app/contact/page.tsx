            ...
            >
                <div className="mb-4">
                    ...
                    <Input
                        ...
                        name="name"
                        required
                        className="mt-1 mb-6 p-2 w-full border rounded-md"
                    />
                    ...
                    <Input
                        ...
                        className="mt-1 mb-6 p-2 w-full border rounded-md"
                    />
                    <label htmlFor="message" className="block text-sm font-medium text-center">
                        お問い合わせ内容
                    </label>
                    <Textarea
                        id="message"
                        name="message"
                        required
                        className="mt-1 mb-8 p-2 w-full border rounded-md"
                        rows={3}
                    ></Textarea>
                    <div className="flex justify-center">
                        <Button
                            type="submit"
                            className="px-8 py-2 rounded bg-blue-600 forground text-white"
                            onPress={onOpen}
                        >
                            送信
                        </Button>
